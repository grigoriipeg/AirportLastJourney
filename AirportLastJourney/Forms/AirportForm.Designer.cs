namespace AirportLastJourney
{
    partial class AirportForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelNullError.Location = new Point(1150, 459);
            labelNullError.Name = "labelNullError";
            labelNullError.Size = new Size(359, 25);
            labelNullError.TabIndex = 57;
            labelNullError.Text = "По вашему запросу ничего не найдено!";
            labelNullError.Visible = false;
            // 
            // buttonList
            // 
            buttonList.Location = new Point(1061, 190);
            buttonList.Name = "buttonList";
            buttonList.Size = new Size(75, 23);
            buttonList.TabIndex = 58;
